...
def train(args):
    ...
    model = lm_VAE(vocab=vocab,
                   ...
                   aggressive_patience=args.aggressive_patience)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--aggressive_patience', default=10, type=int,
                        help='How many epochs to wait after MI stops imporving before halting aggressive training.')
